...
We propose all new method development be added to a collection of R
...
models, indices and metrics to choose from. We have seen many useful
...
change models to forecast impact on invertebrates, water-use models the predict
the impact on fish or flooding models the response of macrophytes. These large
scale environmental models could integrate elements of existing invertebrate,
fish and macrophytes models and reference data into large hybrid models also
...
All ecology data will be freely accessible and
...
insights in environmental harms, biodiversity trends, costs and impacts. Regular
summary reports that are largely drafted automatically provide new findings,
improvements, harms, scenarios can be discussed and addressed.
...
forecasting communities. And smaller scale example such as [ropenSci](https://ropensci.org/).
...
Currently some model packages are shared on github for instance darleq3, fsc2,
rict. We propose these tools are shared under a single package  once the tool is
finalised.
