...
Using the  `assess()` function, we calculate indices, metrics, predictions or reports as required. The 'assessment' stage includes any type of test or categorisation of our data. This could be WFD classification, compliance check, bathing water or discharge assessment. Broadly, any type of grading or assessment against some type of expected value. 
