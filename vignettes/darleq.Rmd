...
standard <- tribble(
  ~question, ~response,
  "name_short", "darleq", 
  "name_long", "River Diatoms (phytobenthos)",
...
standard <- hera:::hera_format(description = standard) # format assessment data
standard
```
...
```{r checklist}
check_list <- hera:::hera_test(description = standard)
...
hera:::update_catalogue(description = standard,
                             data = data,
