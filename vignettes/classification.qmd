...
```{r}
 ...
 lims_eco <- readr::read_csv(
  "vignettes//data//2024-04-10-lims-data.csv"
 )
 ...
 lims_eco <- filter(lims_eco, ANALYSIS %in% c("PAC", "RIVER_DIATOMS", "FW_INVERTS_FIELD", "MTL_TL5","MTL_TL4", "LAB_INVERTS"))
 
 # Remove family level results if MTL present
 check <- lims_eco %>%  select(ANALYSIS, ORIGINAL_SAMPLE) %>% 
   distinct() %>% 
...
# write.csv(alkalinity,"vignettes//data//alkalinity.csv", row.names = FALSE)
...
```{r, message=FALSE}
# write.csv(data,"vignettes//data//2024-03-18-data.csv", row.names = FALSE)
...
# write.csv(results, file = "vignettes\\data\\sample-classification-2023.csv", row.names = FALSE)
# results <- read.csv(file = "vignettes\\data\\sample-classification-2023.csv")
...
replocs <- read.csv("vignettes//data//replocs-2023.csv")
...
write.csv(diatoms_reportable, file = "vignettes\\data\\2023-classification-diatoms.csv", row.names = FALSE)

write.csv(inverts_reportable, file = "vignettes\\data\\2023-classification-inverts.csv", row.names = FALSE)

 write.csv(data, file = "vignettes\\data\\2023-data.csv", row.names = FALSE)
...
# write.csv(results_sample, file = "vignettes\\data\\sample-classification-2023.csv", row.names = FALSE)
```
