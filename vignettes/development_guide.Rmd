...
details <- tibble(
  ...
  Details = c("Short name for assessment < 26 characters for example an abbrivation like TDI",
              ...
              "Optional - Long name for standard for instance Trophic Diatom Index",
