...
model <- tibble(
  ...
  predictions = list(predictions[predictions$sample_id == predictions$sample_id[1], ])
)
...
# demo_data$year <- lubridate::year(demo_data$date_taken)
# demo_data$analysis_name <- NULL
# demo_data$units <- NULL
# demo_data$quality_element <- NULL
# demo_data$taxon <- NULL
# demo_data$result_id <- NULL
# demo_data$standard <- NULL
# demo_data$taxon_id <- NULL
# demo_data$season <- NULL
