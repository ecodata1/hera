...
indices_function <- function(data) {
 # Only calculate metric if required
  ...
  metric <- 
    catalogue$indices_function[
      catalogue$assessment == "Freshwater Invertebrate Model"]
